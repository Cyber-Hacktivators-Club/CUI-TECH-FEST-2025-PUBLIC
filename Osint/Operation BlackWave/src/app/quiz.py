...
def ask_questions():
    ...
    print("=" * 60)
    print("                OPERATION BLACKWAVE - INITIATED")
    print("=" * 60)
    print("\nWelcome, investigator.")
    print("Cyber Hacktivators Club has been compromised and archived under BLACKWAVE.")
    print("Your task is to piece together the truth, one clue at a time.")
    print("The system will test your attention and precision.")
    print("Answer correctly, and you’ll earn access to what’s been hidden.\n")
    print("Deadline: 00:00 PKT, 4 November 2025\n")
    print("Let’s see if you can keep the signal steady.\n")
    print("=" * 60)
